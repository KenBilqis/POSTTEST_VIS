...
Public Class FormUtama
	...
	Private Sub KelolaPeminjamanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles KelolaPeminjamanToolStripMenuItem.Click
		Dim frmPinjam As New FormPeminjaman()
